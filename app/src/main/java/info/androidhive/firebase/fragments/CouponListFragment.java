...
import info.androidhive.firebase.activity.CreateDealActivity;
...
*/
       ...
       /* char c = 'A';
        ...
        adapter = new RecyclerViewAdapter(getActivity(), demoDataDeals,this);
    ...
    void getUserDataFromServer() {
        {
            String url = "https://firbasesamit1.firebaseio.com/deals.json";
